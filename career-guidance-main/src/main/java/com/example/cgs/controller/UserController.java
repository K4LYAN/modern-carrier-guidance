...
public class UserController {
	...
	public String viewPlaylist(@PathVariable("id") Long id, Model model, HttpSession session) {
	    ...
	    if (courseOptional.isPresent()) {
	        ...
	        // Print each playlist item details
	        for (Playlist p : playlist) {
	            System.out.println("Playlist ID: " + p.getId());
	            System.out.println("Playlist Title: " + p.getTitle());
	            System.out.println("Playlist Cover Image: " + (p.getCoverImage() != null ? "Exists" : "Null"));
	            System.out.println("Playlist Video URL: " + p.getVideoUrl());
	        }
